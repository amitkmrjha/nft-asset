...
object Dependencies {
  ...
  val pekkoManagement                 = "org.apache.pekko"  %% "pekko-management"               % Version.pekkoManagement
  val pekkoManagementClusterBootstrap =
    "org.apache.pekko" %% "pekko-management-cluster-bootstrap" % Version.pekkoManagement
  val pekkoManagementHttp = "org.apache.pekko" %% "pekko-management-cluster-http" % Version.pekkoManagement
  ...
  val pekkoStreamsTestKit = "org.apache.pekko" %% "pekko-stream-testkit"          % Version.pekko % "test"
