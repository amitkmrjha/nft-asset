package com.aw.nft.asset.svc.sheduler
...
class QuartzSchedulerSpec extends AnyWordSpecLike with Matchers with BeforeAndAfterAll {

  private lazy val testKit = ActorTestKit(SchedulingConfig.sampleConfiguration)
  ...
  "The Quartz Scheduling Extension" must {
    ...
    val tickTolerance = SchedulingConfig.tickTolerance
